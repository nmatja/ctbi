...
import { Music, MessageCircle, Play, ArrowRight, Shield } from "lucide-react"
...
export function LatestActivity() {
  ...
  if (loading) {
    return (
      <div className="bg-black dark:bg-black rounded-2xl border border-gray-800 dark:border-gray-700 p-8 shadow-lg">
  ...
  return (
    <div className="bg-black dark:bg-black rounded-2xl border-2 border-gray-800 dark:border-gray-700 shadow-xl backdrop-blur-sm relative overflow-hidden">
      <div className="relative p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-semibold bg-gradient-to-r from-orange-600 via-yellow-600 to-red-600 dark:from-orange-400 dark:via-yellow-400 dark:to-red-400 bg-clip-text text-transparent flex items-center gap-3 text-left">
        ...
        <div className="space-y-3 mb-6">
          {activities.length > 0 ? (
            activities.map((activity) => (
              <Card
                key={activity.id}
                className="group hover:shadow-lg transition-all duration-300 bg-gray-900/90 dark:bg-gray-900/90 backdrop-blur-sm border border-gray-700/60 dark:border-gray-600/40 hover:border-orange-300 dark:hover:border-orange-600 rounded-xl overflow-hidden"
              >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        <div className="flex items-center gap-2">
                          ...
                          {activity.type === "review" && (
                            <div className="p-1 rounded-full bg-yellow-100 dark:bg-yellow-900/30">
                              <MessageCircle className="w-3 h-3 text-yellow-600 dark:text-yellow-400" />
                            </div>
                          )}
                        ...
                        <span className="text-xs text-gray-300 dark:text-gray-300 bg-gray-800 dark:bg-gray-700/50 px-2 py-1 rounded-full">
                      ...
                      <h4 className="text-base font-medium text-white dark:text-white line-clamp-1 text-left">
                        {activity.title}
                      </h4>

                      <div className="flex items-center justify-between">
                        <p className="text-xs text-gray-400 dark:text-gray-400 text-left">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            asChild
                            variant="default"
                            className="px-4 py-2 text-sm font-medium bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-full shadow-md hover:shadow-lg transition-all duration-300"
                          >
                          ...
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            className="text-orange-400 hover:text-white dark:text-orange-400 hover:bg-gradient-to-r hover:from-orange-500 hover:to-red-500 dark:hover:from-orange-400 dark:hover:to-red-400 transition-all duration-300 rounded-full w-8 h-8 p-0"
                          >
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-300 dark:text-gray-300 text-lg font-medium">No recent activity yet</p>
              <p className="text-gray-400 dark:text-gray-400 text-sm mt-1">Be the first to share your music!</p>
            </div>
          )}
        </div>

        <div className="text-center space-y-4 pt-4 border-t border-gray-700/50 dark:border-gray-600/30">
