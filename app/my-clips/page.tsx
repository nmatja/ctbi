      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">Upload New Riff</h2>
          ...
          {/* My Clips List */}
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-900">Your Riffs ({clips?.length || 0})</h2>
              ...
              {clips && clips.length > 0 ? (
                clips.map((clip) => (
                  <Card key={clip.id} className="hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="space-y-3">
                      {clip.description && <p className="text-gray-600 text-sm">{clip.description}</p>}
                ...
                <Card>
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600">No riffs uploaded yet. Share your first one!</p>
                  </CardContent>
                </Card>
              )}
            </div>
